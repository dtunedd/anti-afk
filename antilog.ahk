...
aKeysOpposite := {	w: "s"      ; if you dont want the character to move, 
				,	: "w" 		; include the opposite action of a key here - ie if 'w' for forward is sent, an 's' for backward is also sent
				,	: "d"
				,	: "a"}
return 

idleCheck:
if (A_TimeIdle >= 10000) ; this will randomly send input if there has been no input in the last minute (includes artificial input)
{
